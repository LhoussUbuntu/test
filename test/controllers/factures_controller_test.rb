...
class FacturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create facture" do
    assert_difference('Facture.count') do
      post factures_url, params: { facture: { code_client: @facture.code_client, cree_bar: @facture.cree_bar, date: @facture.date, est_regle: @facture.est_regle, est_valid: @facture.est_valid, mode_reglement: @facture.mode_reglement, montant_ht: @facture.montant_ht, montant_ttc: @facture.montant_ttc, montant_tva: @facture.montant_tva, n_facute: @facture.n_facute } }
    end
  ...
  test "should update facture" do
    patch facture_url(@facture), params: { facture: { code_client: @facture.code_client, cree_bar: @facture.cree_bar, date: @facture.date, est_regle: @facture.est_regle, est_valid: @facture.est_valid, mode_reglement: @facture.mode_reglement, montant_ht: @facture.montant_ht, montant_ttc: @facture.montant_ttc, montant_tva: @facture.montant_tva, n_facute: @facture.n_facute } }
